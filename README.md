...
These are my notes and code for a graduate course in Empirical Industrial Organization. All code is written in Julia. I borrow heavily from other sources (below), but all mistakes are mine. The original RMarkdown notebooks can be found [here](https://github.com/matteocourthoud/Empirical-Industrial-Organization/tree/main/Rmd).
